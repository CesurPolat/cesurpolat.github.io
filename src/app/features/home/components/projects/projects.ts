...
@Component({
  ...
  template: `
    <div class="p-4 md:p-8 w-full max-w-5xl h-full overflow-hidden flex flex-col min-h-0">
      <div class="flex items-center gap-3 md:gap-4 mb-5 md:mb-8 border-b-4 border-black self-start">
        ...
        <h2 class="text-3xl md:text-4xl font-black uppercase">Projects</h2>
      </div>
      
      <div class="flex-1 min-h-0 overflow-y-auto custom-scrollbar pr-2">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
          <div *ngFor="let project of projects" 
               class="group relative border-4 border-black bg-white transition-all duration-300 hover:translate-x-2 hover:translate-y-2 hover:shadow-none shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] flex flex-col h-[360px] overflow-hidden">
      ...
      <div class="mt-6 md:mt-10 text-xs md:text-sm font-bold opacity-50 uppercase text-center">© 2026 <app-font-rotation-wrapper [enableTextAnimation]="true">Cesur Polat</app-font-rotation-wrapper></div>
    </div>
  `
})
