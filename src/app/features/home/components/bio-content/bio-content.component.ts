...
@Component({
  ...
  template: `
    <div class="w-full h-full flex flex-col items-center justify-center p-4 lg:p-6 text-white">
      <app-glass-wrapper panelClass="bg-transparent backdrop-blur-[25px] p-6 lg:p-8 rounded-2xl border border-white/10 shadow-2xl overflow-y-auto custom-scrollbar max-h-[85vh] w-full max-w-4xl">
        <!-- Header & Badges -->
